        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="group cursor-pointer">
            <div className="animate-in fade-in-50 slide-in-from-bottom-2 duration-700 motion-reduce:animate-none">
              <div className="inline-block origin-center transform-gpu will-change-transform transition-transform ease-smooth group-hover:scale-105" style={{ transitionDuration: '300ms' }}>
