    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 origin-center will-change-transform transform-gpu scale-100 transition-transform duration-500 ease-smooth hover:scale-110 group-hover:scale-110">
            {/* Base image */}
            <ImageWithFallback
            ...
            {product.hoverImageUrl && (
              <ImageWithFallback
                ...
                fill
                sizes="(min-width:1024px) 33vw, (min-width:640px) 50vw, 100vw"
                className="object-cover w-full h-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-smooth"
                priority={false}
                placeholder="blur"
                blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg=="
                onLoad={() => setImgLoaded(true)}
